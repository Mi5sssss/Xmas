...
def hardware_evaluation(model,wl_weight,wl_activation,model_name,mode): 
    ...
    # f.write('./DNN_NeuroSim_V1.3/Inference_pytorch/NeuroSIM/main /home/rick/nas_rram/ofa/DNN_NeuroSim_V1.3/Inference_pytorch/NeuroSIM/NetWork_'+str(model_name)+'_sampled_subnet'+'.csv '+str(wl_weight)+' '+str(wl_activation)+' ')
    f.write('./DNN_NeuroSim_V1.3/Inference_pytorch/NeuroSIM/main /home/rick/nas_rram/ofa/DNN_NeuroSim_V1.3/Inference_pytorch/NeuroSIM/NetWork'+'.csv '+str(wl_weight)+' '+str(wl_activation)+' ')
