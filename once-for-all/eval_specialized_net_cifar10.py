...
parser.add_argument(
    ...
    type=str,
    default='/home/rick/nas_rram/datasets/cifar10/cifar10-data')
parser.add_argument(
    '-g',
    '--gpu',
...
net = torch.load('/home/rick/nas_rram/ofa_data/exp_resnet/kernel_depth2kernel_depth_width/phase2/checkpoint/intact_model_best.pth.tar')
...
data_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CIFAR10(root=args.path, train=False,
